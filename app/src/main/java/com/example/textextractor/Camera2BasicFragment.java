...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir(null),"pic.jpg");//add function to get different names for images
   ...
   The blocks are stored in a list of return type Block from Firebase Vision.*/
       ...
       /* // Task completed successfully
                ...
                FirebaseVisionDocumentText resultText = result.text;
        ...
        public void run() {
            ...
            try {
                ...
                if (null != output) {
                    ...
                    Bitmap bitmap = BitmapFactory.decodeFile("pic.jpg");
                    //ByteArrayOutputStream blob = new ByteArrayOutputStream();
                    //bitmap.compress(CompressFormat.PNG, 0 /* Ignored for PNGs */, blob);
                    //byte[] bitmapdata = blob.toByteArray();
                    //FirebaseVisionTextRecognizer firebaseVisionTextRecognizer = FirebaseVision.getInstance().getOnDeviceTextRecognizer();
                    FirebaseVisionImage image = FirebaseVisionImage.fromBitmap(bitmap);
                    //result = firebaseVisionTextRecognizer.processImage(image);
